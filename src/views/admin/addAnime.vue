  ...
  <div id="admin">
    <el-row class="tac">
      ...
      <el-col class="anime">
        ...
        <el-button type="warning" round @click="add">添加</el-button>
      </el-col>
    </el-row>
  </div>
</template>
...
<script>
import { setAnime } from "@/network/list.js";
export default {
  data() {
    return {
      textarea1: "",
  ...
  methods: {
    add() {
      setAnime(this.textarea1, this.textarea2, this.textarea3, this.img).then(
        (res) => {}
      );
    },
    select(index) {
